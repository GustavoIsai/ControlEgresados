		...
		<div class="row">
          ...
          <form action = "registroCode.php" method="POST" role="form">
              ...
              <div class="form-group">
                ...
                <input type="text" name="txtApellidopat" class="form-control" id="nombre" autofocus required placeholder="">
              </div>

              <div class="form-group">
                <label for="nombre">Apellido Materno</label>
                <input type="text" name="txtApellidomat" class="form-control" id="nombre" autofocus required placeholder="">
              </div>
